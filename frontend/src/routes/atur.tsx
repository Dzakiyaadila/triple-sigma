          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                SKU yang dilindungi mendapat floor minimal 1 unit bila baseline stockout risk
                lebih dari 0. Jika floor tidak feasible terhadap budget, backend menolak run.
              </p>
            </div>
